...
class ReservationApi
{
    ...
    {
        list($response) = $this->cancelReservationWithHttpInfo($channel_id, $id, $reservation);
        return $response;
    }
    ...
    public function cancelReservationWithHttpInfo($channel_id, $id, $reservation)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\HapiCommand\Model\NoChannelFoundError' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HapiCommand\Model\NoChannelFoundError', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HapiCommand\Model\NoChannelFoundError',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function cancelReservationAsync($channel_id, $id, $reservation)
    {
        return $this->cancelReservationAsyncWithHttpInfo($channel_id, $id, $reservation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function cancelReservationRequest($channel_id, $id, $reservation)
    {
        // verify the required parameter 'channel_id' is set
        if ($channel_id === null || (is_array($channel_id) && count($channel_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_id when calling cancelReservation'
            );
        }
        ...
        if ($reservation === null || (is_array($reservation) && count($reservation) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reservation when calling cancelReservation'
            );
        }

        $resourcePath = '/{channelId}/reservations/{id}/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->createReservationWithHttpInfo($channel_id, $reservation);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createReservationAsync($channel_id, $reservation)
    {
        return $this->createReservationAsyncWithHttpInfo($channel_id, $reservation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createReservationRequest($channel_id, $reservation)
    {
        // verify the required parameter 'channel_id' is set
        if ($channel_id === null || (is_array($channel_id) && count($channel_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_id when calling createReservation'
            );
        }
        // verify the required parameter 'reservation' is set
        if ($reservation === null || (is_array($reservation) && count($reservation) === 0)) {
        ...
        $resourcePath = '/{channelId}/reservations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->updateReservationWithHttpInfo($channel_id, $reservation);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateReservationAsync($channel_id, $reservation)
    {
        return $this->updateReservationAsyncWithHttpInfo($channel_id, $reservation)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateReservationRequest($channel_id, $reservation)
    {
        // verify the required parameter 'channel_id' is set
        if ($channel_id === null || (is_array($channel_id) && count($channel_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_id when calling updateReservation'
            );
        }
        // verify the required parameter 'reservation' is set
        if ($reservation === null || (is_array($reservation) && count($reservation) === 0)) {
